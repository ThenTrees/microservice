...
@Tag(
        name = "CRUD REST APIs for Loans in Thentrees",
        description = "CRUD REST APIs in Thentrees to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside Thentrees"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<LoanDto> fetchLoanDetails(
        ...
        logger.debug("thentrees-correlation-id found: {} ", correlationId);
