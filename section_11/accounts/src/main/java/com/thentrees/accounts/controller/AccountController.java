...
@Tag(
        name = "CRUD REST APIs for Account in ThentreesBank",
        description = "CRUD REST APIs in ThentreesBank to CURD account details"
)
@RestController
...
public class AccountController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside ThentreesBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<String> getBuildInfo() {
        LOGGER.debug("GET buildInfo() method Invoked");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(buildVersion);
    }
    ...
    public ResponseEntity<String> getBuildInfoFallback(Throwable throwable) {
        LOGGER.debug("GET buildInfoFallback() method Invoked");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("0.9");
    }
